...
{
    [SerializeField] float legSpacing = 3.5f;
    [SerializeField] float legRotation = 60f;
    [SerializeField] float stepLength = 2f;
    [SerializeField] float speed = 4f;

    [SerializeField] Animator casinoAnimator;
    ...
    [SerializeField] ChainIKConstraint[] ikComponents = new ChainIKConstraint[4];
    [SerializeField] Transform centralBody;

    private Transform[] legsTargets = new Transform[4];
    Vector3[] currentTargets = new Vector3[4];
